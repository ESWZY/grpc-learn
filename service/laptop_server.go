...
// LaptopServer is the server that provide laptop services
...
func NewLaptopServer(store LaptopStore, imageStore ImageStore) *LaptopServer {
	return &LaptopServer{store, imageStore}
}
...
func (server *LaptopServer) UploadImage(stream pb.LaptopService_UploadImageServer) error {
	...
	laptopID := req.GetInfo().GetLaptopId() // use GetInfo() to get info field of UploadImageRequest
