...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 4: grpc.learn.Laptop
	(*Filter)(nil),               // 5: grpc.learn.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: grpc.learn.CreateLaptopRequest.laptop:type_name -> grpc.learn.Laptop
	5, // 1: grpc.learn.SearchLaptopRequest.filter:type_name -> grpc.learn.Filter
	4, // 2: grpc.learn.SearchLaptopResponse.laptop:type_name -> grpc.learn.Laptop
	0, // 3: grpc.learn.LaptopService.CreateLaptop:input_type -> grpc.learn.CreateLaptopRequest
	2, // 4: grpc.learn.LaptopService.SearchLaptop:input_type -> grpc.learn.SearchLaptopRequest
	1, // 5: grpc.learn.LaptopService.CreateLaptop:output_type -> grpc.learn.CreateLaptopResponse
	3, // 6: grpc.learn.LaptopService.SearchLaptop:output_type -> grpc.learn.SearchLaptopResponse
